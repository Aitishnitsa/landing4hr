...
const SelectionOf = ({ title, undertitle, tools, cardsInfo, children, id }) => {
  return (
    <section
      id={id}
      className="h-full relative flex flex-col space-y-10 md:space-y-20 justify-between items-center my-20 lg:my-[200px]"
    >
      ...
      <ul className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-4 lg:space-x-8 relative z-50 max-w-[216px] md:max-w-2xl lg:max-w-full w-full md:w-fit">
